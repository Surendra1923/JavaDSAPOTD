...
public class string_rotated {
    ...
    public static boolean isRotated(String str1, String str2)
    {
        ...
        String sub1 = S.substring(2, str1.length()+2);
        
        String sub2 = S.substring(str1.length()-2, (str1.length()*2)-2);
        
        if(sub1.equals(str2) || sub2.equals(str2)){
            return true;
        }
        return false;
    }
